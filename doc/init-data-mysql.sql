...
--
INSERT INTO sys_user (login_name, password, name, phone, email, is_builtin, login_time, password_last_modify_time, update_time, create_time)
VALUES ('administrator', '123456', 'wsy', '17601612994', 'wsy2355883@163.com', true, '2015-10-12 14:12:52', '2015-10-12 14:12:52', '2015-10-12 14:12:52', '2015-10-12 14:12:52');

INSERT INTO sys_user (login_name, password, name, phone, email, is_builtin, login_time, password_last_modify_time, update_time, create_time)
VALUES ('admin', 'admin', 'wsy', '17601612994', 'wsy2355883@163.com', true, '2015-10-12 14:12:52', '2015-10-12 14:12:52', '2015-10-12 14:12:52', '2015-10-12 14:12:52');
...
delete from sys_role_menu;
insert into sys_role_menu (ROLE_ID,MENU_ID,UPDATE_TIME,CREATE_TIME)
select 1, ID, now(), now() from sys_menu;

insert into sys_user_role (USER_ID, ROLE_ID, UPDATE_TIME, CREATE_TIME) VALUES (1, 1, now(), now());
